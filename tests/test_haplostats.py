...
def test_get_haplotypes_shared_between_subsets_including_empty(stats_example: HaploStats):
...
def test_get_fields_of_recombination_shared_between_subsets_including_empty(stats_example: HaploStats):
    assert stats_example.get_fields_of_recombination_shared_between_subsets(include_empty=True) == [
        {
            'species_a': 'verrucosa',
            'species_b': 'enigmatica',
            'common': {
